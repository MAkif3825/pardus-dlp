...
/**
 * @brief Reads an extension blocklist file and loads strings directly into the eBPF map.
 ...
 * @return int Number of extensions successfully loaded on success, negative error code on failure.
 */
