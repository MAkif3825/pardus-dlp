...
/**
 * @brief Checks a file's size and computes its SHA256 cryptographic hash
 * string.
 *
 ...
 */
bool file_utils_calculate_sha256(const char *filepath, char *out_sha256,
				 size_t max_size_bytes);

/**
 * @brief Strips leading and trailing whitespace/newlines from a string
 * in-place.
